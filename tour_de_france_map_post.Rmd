...
description: |
  Plotting Tour de France stages onto a single.
author:
  - name: Julian During
...
base_url: https://www.datannery.com/posts/tour_de_france_map/
params:
  interactive: TRUE
editor_options: 
...
```{r, code=df_manifest$command[df_manifest$name == "gg_tdf_stages"]}
```
